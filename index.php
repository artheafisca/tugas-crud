      ...
      <div class="container">
        ...
        <table border="2" align="center" width="75%">
          ...
          while($mhs = mysqli_fetch_array($query)){
            ...
            echo "<td>";
            echo "<a href='form_edit.php?id=".$mhs['nim']."'>Edit</a> | ";
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  $sql = "SELECT * FROM mahasiswa where jurusan='statistika'";
          $query = mysqli_query($koneksi, $sql);
          while($mhs = mysqli_fetch_array($query)){
            ?>
            <?php
        ...
        <!-- <div class="row">
          ...
          <div class="col-lg-5 col-md-12" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="form-group">
              ...
              <div class="text-center"><button type="submit" name="submit" value="Simpan">Submit</button></div>
            </form>
          </div>
